    ...
    return (
        <Container>
            ...
            <RightSide>
                ...
                <Tech top={32} left={80} width={96} height={96}><NodeJs /></Tech>
                <Tech top={32} right={80} width={80} height={80}><React /></Tech>
                <Tech top={160} right={80} width={120} height={120}><Next /></Tech>
                <Tech top={180} left={120} width={80} height={80}><Laravel /></Tech>
            </RightSide>
        </Container>
    )
}
