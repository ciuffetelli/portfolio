    ...
    return (
        <Container>
            ...
            <RightSide>
                ...
                <Tech top={2} left={5} width={6} height={6}><NodeJs /></Tech>
                <Tech top={2} right={5} width={5} height={5}><React /></Tech>
                <Tech top={10} right={5} width={7} height={7}><Next /></Tech>
                <Tech top={10} left={5} width={5} height={5}><Laravel /></Tech>
            </RightSide>
        </Container>
    )
}
